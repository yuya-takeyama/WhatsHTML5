...
PreZen = (function () {
  ...
  initSlide = function () {
    ...
    } else if ($(this).hasClass('impression')) {
      $(this).html('<div class="impression-background"><image src="' + $(this).attr('data-background') + '" /></div><div class="impression-label">' + $(this).html() + '</div>');
    }
  };
